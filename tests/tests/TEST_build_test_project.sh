...
rm -rf rem_workdir
rem ARCH=arm MACH=stm32f1 PROJECT_FOLDER="rem_packages rem_test_project" -m -j4 package:test_project:image[bin] VERBOSE=1
rm -rf rem_workdir
rem ARCH=arm MACH=stm32f3 PROJECT_FOLDER="rem_packages rem_test_project" -m -j4 package:test_project:image[bin] VERBOSE=1
rm -rf rem_workdir
rem ARCH=arm MACH=stm32f4 PROJECT_FOLDER="rem_packages rem_test_project" -m -j4 package:test_project:image[bin] VERBOSE=1
rm -rf rem_workdir
rem ARCH=8051 MACH=nrf24le1_32 PROJECT_FOLDER="rem_packages rem_test_project" -m -j4 package:test_project:image[bin] VERBOSE=1
rm -rf rem_workdir
